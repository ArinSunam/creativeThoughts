  ...
  return (
    <div className="mt-[50px] grid grid-cols-2 gap-[100px] mmd:flex mmd:flex-col mmd:text-center mmd:items-start">
      ...
      <div className="col-start-1 col-end-2 flex flex-col  gap-[40px]">
        ...
        <p className="text-[15px]  mmd:w-[85vw]">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero nulla tenetur fuga quis architecto rem.</p>

        {/* Buttons */}
        <div className="flex gap-[20px] mmd:justify-center">
